...
import 'package:the_word_game/utils/game/widgets/decounter.dart';
...
class GameBackground extends StatelessWidget {
  ...
  const GameBackground({Key key, this.assetPath, this.child}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          ...
          image:
              DecorationImage(image: AssetImage(assetPath), fit: BoxFit.fill)),
      child: child,
    );
  }
}
